...
private:
    ...
    static void ecu_protocol_crc_correct(void*,ecu_link_layer_t* protocol) {
    ...
    static void ecu_protocol_crc_incorrect(void*,ecu_link_layer_t* protocol) {
